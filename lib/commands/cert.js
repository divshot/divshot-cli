...
var use = 'cert <certifcate> <key> <optional-cabundle>';
module.exports = function (cli) {
  ...
  command.handler(function (certificateFile, keyFile, cabundleFile, done) {
    ...
    var hasBundle = (!requireCabundle || requirePath(cabundleFile, 'CA Bundle'));
    ...
    if (requireCabundle) {
      payload.ssl_cabundle = fs.readFileSync(cabundleFile).toString();
    }
