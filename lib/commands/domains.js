...
module.exports = function (cli) {
  ...
  add.handler(function (domain, done) {
    ...
    cli.api.apps.id(appName).domains.add(domain, function (err, response, body) {
      ...
      cli.log('See http://docs.divshot.io/guides/domains for details on how to configure DNS for your domain.');
      ...
      if (data.apex) {
        ...
        cli.log('Be sure to check the documentation for extra details about Apex domain configuration: ' + format.bold('http://docs.divshot.io/guides/domains'));
      }
