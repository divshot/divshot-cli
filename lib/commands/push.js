...
TEN_MB = 1000000
function checkFileSizes (directory) {
  var tooBig = [];
  ...
  if (tooBig.length > 0) {
    console.error("Files MUST NOT be greater than 10MB.".red)
    tooBig.forEach(function (path) {
      console.error(path.yellow + " is too big.");
    });
    process.exit(1);
  }
}
