...
module.exports = function (app) {
  app.program
    ...
    .handler(function () {
      ...
      checkFileSizes(app, appRootDir);

      app.logger.writeln('Creating build ... ');
      
      
      // var deploy = Deploy.initiate({
      //   app: app,
      //   appName: ioApp,
      ...
      ioApp.builds.create(payload, initiateDeploy(app, ioApp, environment, process.cwd(), appRootDir, function (err) {
        if (err) {
