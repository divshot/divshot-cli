...
app.use(flatiron.plugins.cli, {
  ...
  usage: "Divshot.io Command Line Interface\nrun " + "divshot help".green + " for a list of available commands"
});

app.cmd("help", function() {
  console.info("For additional help, run:".underline + " divshot help <commandname>".green);
  console.info("Available commands:".blue);
...
app.api = Divshot.createClient({
  ...
  host: 'https://api.divshot.com' //env.API_HOST
});
